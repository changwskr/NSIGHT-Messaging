...
/** MyBatis 엔티티 — TB_MSG_MESSAGE */
public class XpmMessage {
    ...
    public static XpmMessage create(String messageCode, String messageName, String messageType, String channelCode,
                                    String locale, String messageContent, LocalDateTime displayStartAt,
                                    LocalDateTime displayEndAt, String useYn, String userId) {
        XpmMessage message = new XpmMessage();
