package com.nh.nsight.messaging.file.thing;
...
public class FileDocument {
    ...
    public static FileDocument create(String originalName, String storedName, String contentType, long fileSize,
        ...
        document.bizCategory = bizCategory;
