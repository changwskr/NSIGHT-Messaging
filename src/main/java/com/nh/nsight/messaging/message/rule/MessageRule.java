...
public class MessageRule {
    ...
    public void validateCreate(MessageCreateRequest request) {
        validateFields(request.messageCode(), request.messageType(), request.channelCode(),
                request.useYn(), request.displayStartAt(), request.displayEndAt());
    }

    public void validateUpdate(MessageUpdateRequest request) {
        validateFields(request.messageCode(), request.messageType(), request.channelCode(),
                request.useYn(), request.displayStartAt(), request.displayEndAt());
    }
