...
-- TB_FW_TX_STATUS / TB_FW_TX_LOG / TB_FW_AUDIT_LOG (전처리·후처리 모듈 샘플)
INSERT INTO TB_FW_TX_STATUS (
    GUID, TRACE_ID, TRANSACTION_ID, SERVICE_ID, USER_ID, BRANCH_ID, CHANNEL_ID,
    STATUS, RESULT_CODE, REQUEST_TIME, START_TIME, END_TIME, ELAPSED_TIME, IDEMPOTENCY_KEY
) VALUES
('20260603-FW-001', 'TRACE-FW-001', 'XPFW-PROCESS-001', 'xpilotFrameworkProcess', 'ARCHITECT', '360001', 'WEB',
 'SUCCESS', 'COM-0000', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 42, 'IDEM-FW-001'),
('20260603-FW-002', 'TRACE-FW-002', 'XPFW-PROCESS-002', 'xpilotFrameworkProcess', 'ARCHITECT', '360001', 'WEB',
 'FAIL', 'FAIL', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 18, 'IDEM-FW-002');
...
('20260603-FW-001', 'TRACE-FW-001', 'xpilotFrameworkProcess', 'ARCHITECT',
 '/api/xpilotframewrok/process', 'POST', 'COM-0000', NULL, 'AP-01', 12, 5, 42),
('20260603-FW-002', 'TRACE-FW-002', 'xpilotFrameworkProcess', 'ARCHITECT',
 '/api/xpilotframewrok/process', 'POST', 'FAIL', 'BIZ-001', 'AP-01', 8, 3, 18);
...
('20260603-FW-001', 'ARCHITECT', '360001', 'FW-LOG', 'MXPFW76001', 'CUST-001',
 'INQUIRY', '전후처리 파이프라인 실행', 'GENERAL', 'COM-0000', '127.0.0.1'),
('20260603-FW-002', 'ARCHITECT', '360001', 'FW-LOG', 'MXPFW72001', NULL,
 'INQUIRY', '성능로그 조회', 'GENERAL', 'COM-0000', '127.0.0.1');
